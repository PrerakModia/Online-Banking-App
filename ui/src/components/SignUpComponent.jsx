  ...
  return (
    <div className='main_container'>
     <form onSubmit={submitActionHandler}>
        ...
        <TextField id="outlined-basic" sx={{p:2}} variant="outlined" type="text" value={firstName} onChange={(event)=>{setFirstName(event.target.value)}} placeholder="Enter your Name" required/><br />
        <TextField id="outlined-basic" sx={{p:2}} variant="outlined" type="text" value={lastName} onChange={(event)=>{setLastName(event.target.value)}} placeholder="Enter your Name" required/><br />
