  ...
  return (
    <div className='main_container'>
     <form onSubmit={submitActionHandler}>
        ...
        <TextField id="outlined-basic" sx={{p:2}} variant="outlined" type="text" value={firstName} onChange={(event)=>{setFirstName(event.target.value)}} placeholder="Enter your first Name" required/><br />
        <TextField id="outlined-basic" sx={{p:2}} variant="outlined" type="text" value={lastName} onChange={(event)=>{setLastName(event.target.value)}} placeholder="Enter your  Last Name" required/><br />
        ...
        <TextField id="outlined-basic" sx={{p:2}} variant="outlined" type="number" value={salary} onChange={(event)=>{setSalary(event.target.value)}} placeholder="Enter your Salary" required/><br />
        <TextField id="outlined-basic" sx={{p:2}} variant="outlined" type="text" value={occupation} onChange={(event)=>{setOccupation(event.target.value)}} placeholder="Enter your Occupation" required/><br />
